  ...
  return (
    <div
      ...
      className={cn(
        ...
        isHovered
          ? 'bg-gradient-to-br from-blue-400 via-blue-500 to-blue-700 text-white shadow-2xl border-2 border-blue-400'
        ...
        <div
          className={cn(
            ...
            isHovered
              ...
              : 'bg-blue-50 dark:bg-blue-950/40 text-blue-400 dark:text-blue-300'
          )}
        >
