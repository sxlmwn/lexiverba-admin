...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const courierNav = [
    ...
    { id: 'deliveries', label: 'Assigned Deliveries', icon: 'local_shipping', badge: '11' },
    { id: 'pending', label: 'Pending', icon: 'pending_actions', badge: '5' },
          ...
          <div className="flex items-center gap-3">
            ...
            {!isCollapsed && (
              <div className="flex flex-col">
                <span className={`font-semibold text-xl tracking-tight transition-opacity duration-200 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
                  LexiVerba
                </span>
                <span className="text-[10px] font-semibold text-blue-500">Courier Portal</span>
              </div>
            )}
          </div>
